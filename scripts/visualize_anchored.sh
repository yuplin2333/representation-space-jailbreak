python visualizer_anchored.py \
    ...
    --datasets "./data/visualization/gcg_llama2-7b_original.csv" "./data/visualization/gcg_llama2-7b_jailbreak.csv" "./data/visualization/gcg_llama2-7b_jailbreak_failed.csv" \
